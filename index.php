...
011.** Rev History
012.**------------------------------------------------------------------------------
013.*/ //-- กำหนดช่องเวลา แบบตายตัว 
$timeArr = array("07:00", "08:00", "09:00", "10:00", "11:00", "12:00", "13:00", "14:00","15:00", "16:00", "17:00", "18:00", "19:00", "20:00", "21:00", "22:00");
//-- ตารางห้องประชุม.//-- ส่วนที่ดึงมาจากฐานข้อมูล ในลูป while ซึ่งมีจำนวนห้องประชุมทั้งหมด 5 ห้อง
$room = array();
...
echo '<div class="draggable2" style="left: '.$left.'px;width: '.$width.'px" title="'.$title.'">'. $title
. '</div>';
}
}
echo '  </div>
